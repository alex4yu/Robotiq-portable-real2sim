#!/usr/bin/env python3
"""
Toggle RealSense recording (IR1, IR2, and Color; no Depth) with joystick button.
...
class Recorder:
    ...
    def spin_once(self, timeout_s=0.03):
...
def main():
    ...
    print("[READY] Press joystick button to START/STOP recording (IR1, IR2, Color; no Depth).")
